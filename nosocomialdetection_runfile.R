...
# Mui's function
nosocomial.detection(cutoff, prob_latent, prob_los)
# Ben's function
calc_prob_infection_meets_def_nosocomial(cutoff,prob_los,prob_latent)

# Simulation
sim <- nosocomial.simulation(n_max=1000,
                             los_distr=prob_los, 
